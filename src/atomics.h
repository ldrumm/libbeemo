...
//Windows XP and later: The return value is the resulting incremented value. Therefore we subtract 1 from the result to align with the GCC macro
#define BMO_ATOM_INC(xp) \
    (InterlockedIncrement64((xp))-1)

#define BMO_ATOM_DEC(xp) \
    (InterlockedDecrement64((xp))-1)
