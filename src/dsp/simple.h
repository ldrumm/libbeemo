...
void bmo_zero_mb_offset(float **in, uint32_t channels, uint32_t frames,
                        uint32_t offset);
void bmo_convolve_sb(float *out, float *in, float *impulse, uint32_t samples,
                     uint32_t impulselen);
