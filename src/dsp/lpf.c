...
a sliding window averaging filter based on a multiple pass variable window length. Very poor cutoff curve at about 3dB/8ve, though the duff's device implementation makes it fast as it produces nicely vectorized code*/
